...
final class Seeder
{
    ...
    {
        if (! DemoMode::enabled()) {
            throw new RuntimeException('Demo seeding requires WMCP_AGENTOPS_DEMO_MODE=true.');
        }
        ...
        update_option('wmcp_agentops_store_policies', $this->policies($pages), false);
        ...
        update_option('wmcp_agentops_pages', $pages, false);
    ...
    private function seed_pages(): array
    {
        $definitions = array(
            ...
            'agentops'   => array('Agent SNR — Monitor', 'agentops-demo', '[wmcp_agentops_demo]'),
