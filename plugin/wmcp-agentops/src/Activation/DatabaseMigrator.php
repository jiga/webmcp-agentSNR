...
final class DatabaseMigrator
{
    ...
    {
        if (Versions::DATABASE === (string) get_option('wmcp_agentops_db_version', '')) {
            return;
        }
        ...
        dbDelta(
            "CREATE TABLE {$prefix}wmcp_workflows (
                ...
                demo_session_hash binary(32) DEFAULT NULL,
                protocol varchar(16) NOT NULL DEFAULT 'webmcp',
                surface varchar(32) NOT NULL,
                status varchar(24) NOT NULL DEFAULT 'active',
                wp_user_id bigint(20) unsigned DEFAULT NULL,
                actor_hash binary(32) DEFAULT NULL,
                wc_session_hash binary(32) DEFAULT NULL,
        ...
        dbDelta(
            "CREATE TABLE {$prefix}wmcp_order_links (
                ...
                first_touch_at datetime(6) NOT NULL,
                last_touch_at datetime(6) NOT NULL,
                ...
                updated_at datetime(6) NOT NULL,
                PRIMARY KEY  (id),
                UNIQUE KEY order_workflow_rule (order_id,workflow_id,rule_version),
