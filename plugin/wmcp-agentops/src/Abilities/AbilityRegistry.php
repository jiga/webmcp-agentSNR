...
final class AbilityRegistry
{
    ...
    public function register_categories(): void
    {
        wp_register_ability_category(
            'wmcp-storefront',
            array(
                'label'       => __('WebMCP storefront', 'wmcp-agentops'),
                'description' => __('Safe public storefront and commerce-session capabilities.', 'wmcp-agentops'),
            )
        );
        ...
        wp_register_ability_category(
            'wmcp-agentops',
            array(
                'label'       => __('Agent SNR monitor', 'wmcp-agentops'),
        ...
        foreach ($this->catalog->all() as $definition) {
            ...
            wp_register_ability(
                ...
                array(
                    ...
                    'category'            => 'storefront' === $definition['surface'] ? 'wmcp-storefront' : 'wmcp-agentops',
