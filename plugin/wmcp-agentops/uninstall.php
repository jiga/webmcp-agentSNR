...
if (get_option('wmcp_agentops_delete_data_on_uninstall', false)) {
    ...
    delete_option('wmcp_agentops_tool_policies');
    delete_option('wmcp_agentops_kill_switch');
    delete_option('wmcp_agentops_store_policies');
    delete_option('wmcp_agentops_pages');
    delete_option('wmcp_agentops_playground_url');
    delete_option('wmcp_agentops_repository_url');
    delete_option('wmcp_agentops_release_url');
