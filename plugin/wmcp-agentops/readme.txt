...
Tags: webmcp, woocommerce, agentops, analytics, ai
...
WP WebMCP AgentOps is an open-source, local-first operations layer for browser agents on WordPress. It registers narrowly scoped top-level WebMCP tools backed by WordPress Abilities, records redacted workflow outcomes, links same-session WooCommerce orders and refunds, and provides merchant analytics and policy controls.
...
3. Review the AgentOps settings before enabling any tool.
