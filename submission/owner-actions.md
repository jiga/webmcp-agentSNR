...
- [ ] Deploy the exact release tag and seed/freeze a public demo that remains free through September 21, 2026 at 5:00 p.m. PDT.
- [ ] Run the full logged-out public smoke test, cache-isolation test, and two-session test from an external device.
