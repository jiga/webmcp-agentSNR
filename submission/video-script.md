...
| 1:35–2:03 | Agent SNR, Workflow Replay, Opportunity Signals, outcomes | “Agent SNR replays the same workflow and keeps three evidence classes visible: Site observed demand, Agent reported feedback, and Site verified catalog and WooCommerce outcomes. Raw prompts, addresses, and payment details are absent.” |
...
| 2:30–2:40 | Eval fixtures, repo, ZIP, Docker/Playground artifacts, closing rail | “The exact release ships with pinned native WebMCP smoke, model eval fixtures, and clear Workbench and public-directory gates—so this journey can be tested, published, and improved.” |
