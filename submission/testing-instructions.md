...
1. Open **https://agent-snr.onrender.com/** as a top-level page in the latest ChatGPT desktop in-app browser, or Chrome 149+ with `chrome://flags/#enable-webmcp-testing` enabled.
...
8. Open **https://agent-snr.onrender.com/agentsnr-demo/** (Agent SNR) and run the merchant prompt. Confirm Agent Sessions, Workflow Replay, Opportunity Signals, tool health, the paid order, attribution evidence, gross/refund/net, and separate Site observed / Agent reported / Site verified labels are visible.
