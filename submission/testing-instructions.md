...
6. Open **[AGENTOPS_URL]** (Agent Experience Monitor) and run the merchant prompt. Confirm Agent Sessions, Workflow Replay, Signals, tool health, journey, capability gap, paid order, attribution evidence, gross revenue, refund total, and net revenue are visible.
